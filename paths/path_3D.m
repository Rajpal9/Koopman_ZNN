...
% rd_ddot -  desired position
    ...
    if strcmpi(shape,'adobe') == 1
        ...
        rd_dot = [-0.8*n*pi*c*sin(0.4*pi*t) - 0.6*n*pi*c*sin(0.2*pi*t);
                   0.8*n*pi*c*cos(0.4*pi*t)*cos(tilt) - 0.6*n*pi*c*cos(0.2*pi*t)*cos(tilt);
                   0.8*n*pi*c*cos(0.4*pi*t)*sin(tilt) - 0.6*n*pi*c*cos(0.2*pi*t)*sin(tilt)];
                   
        rd_ddot = [-0.32*(n*pi)^2*c*cos(0.4*pi*t) - 0.12*(n*pi)^2*c*cos(0.2*pi*t);
                  -0.32*(n*pi)^2*c*sin(0.4*pi*t)*cos(tilt) + 0.12*(n*pi)^2*c*sin(0.2*pi*t)*cos(tilt);
                  -0.32*(n*pi)^2*c*sin(0.4*pi*t)*sin(tilt) + 0.12*(n*pi)^2*c*sin(0.2*pi*t)*sin(tilt)];
   ...
   elseif strcmpi(shape,'hyp') == 1
       rd = [2*c*cos(0.2*pi*t) - c*cos(0.8*pi*t) + rd_0(1) - c;
        ...
        rd_dot =  [-0.4*c*n*pi*sin(0.2*pi*t)+ 0.8*c*n*pi*sin(0.8*pi*t);
                   0.4*c*n*pi*cos(0.2*pi*t)*cos(tilt)- 0.8*c*n*pi*cos(0.8*pi*t)*cos(tilt);
                   0.4*c*n*pi*cos(0.2*pi*t)*sin(tilt)- 0.8*c*n*pi*cos(0.8*pi*t)*sin(tilt)];
                   
        rd_ddot = [-0.08*c*(n*pi)^2*cos(0.2*pi*t)+ 0.64*c*(n*pi)^2*cos(0.8*pi*t);
                 -0.08*c*(n*pi)^2*sin(0.2*pi*t)*cos(tilt) + 0.64*c*(n*pi)^2*sin(0.8*pi*t)*cos(tilt);
                 -0.08*c*(n*pi)^2*sin(0.2*pi*t)*sin(tilt) + 0.64*c*(n*pi)^2*sin(0.8*pi*t)*sin(tilt)];

    elseif strcmpi(shape,"epicycloid") == 1
        rd = [4*c*cos(0.2*pi*t)-c*cos(0.8*pi*t)+rd_0(1)-3*c;
        ...
        rd_dot = [-4*c*sin(0.2*pi*t)*(0.2*pi*n)+c*sin(0.8*pi*t)*(0.8*pi*n);
                   4*c*cos(0.2*pi*t)*(0.2*pi*n)*cos(tilt)-c*cos(0.8*pi*t)*(0.8*pi*n)*cos(tilt);
                   4*c*cos(0.2*pi*t)*(0.2*pi*n)*sin(tilt)-c*cos(0.8*pi*t)*(0.8*pi*n)*sin(tilt)];

        rd_ddot = [-4*c*cos(0.2*pi*t)*(0.2*pi*n)^2+c*cos(8*pi*t)*(0.8*pi*n)^2;
                   -4*c*sin(0.2*pi*t)*cos(tilt)*(0.2*pi*n)^2+c*sin(0.8*pi*t)*cos(tilt)*(0.8*pi*n)^2;
                   -4*c*sin(0.2*pi*t)*sin(tilt)*(0.2*pi*n)^2+c*sin(0.8*pi*t)*sin(tilt)*(0.8*pi*n)^2];
            
    elseif strcmp(shape,'lissajous')

        rd = [4*c*sin(0.2*pi*t) + rd_0(1);
              3*c*sin(0.4*pi*t)*cos(tilt) + rd_0(2);
              4*c*sin(0.2*pi*t)*sin(tilt) + rd_0(3)];

        rd_dot = [4*c*(0.2*pi/n)*cos(0.2*pi*t);
                  3*c*(0.4*pi/n)*cos(0.4*pi*t)*cos(tilt);
                  4*c*(0.2*pi/n)*cos(0.2*pi*t)*sin(tilt)];
    
        rd_ddot = [-4*c*((0.2*pi/n)^2)*sin(0.4*pi*t);
                   -3*c*((0.4*pi/n)^2)*sin(0.2*pi*t)*cos(tilt);
    ...
    elseif strcmpi(shape,'circle') == 1
       ...
       rd_dot = [-c*0.2*n*pi*sin(0.2*pi*t);
                  c*0.2*n*pi*cos(0.2*pi*t)*cos(tilt);
                  c*0.2*n*pi*cos(0.2*pi*t)*sin(tilt)];
                   
       rd_ddot = [-c*((0.2*n*pi)^2)*cos(0.2*pi*t);
                  -c*((0.2*n*pi)^2)*sin(0.2*pi*t)*cos(tilt);
                  -c*((0.2*n*pi)^2)*sin(0.2*pi*t)*sin(tilt)];
    ...
    elseif strcmpi(shape,'cardioid') == 1
       ...
       rd_dot = [-2*c*0.2*n*pi*sin(0.2*pi*t)+c*0.4*n*pi*sin(0.4*pi*t);
                  2*c*0.2*n*pi*cos(0.2*pi*t)*cos(tilt)-c*0.4*n*pi*cos(0.4*pi*t)*cos(tilt);
                  2*c*0.2*n*pi*cos(0.2*pi*t)*sin(tilt)-c*0.4*n*pi*cos(0.4*pi*t)*sin(tilt)];
                   
        rd_ddot = [-2*c*(0.2*n*pi)^2*cos(0.2*pi*t)+c*0.4^2*(n*pi)^2*cos(0.4*pi*t);
                   -2*c*(0.2*n*pi)^2*sin(0.2*pi*t)*cos(tilt)+c*0.4^2*(n*pi)^2*sin(0.4*pi*t)*cos(tilt);
                   -2*c*(0.2*n*pi)^2*sin(0.2*pi*t)*sin(tilt)+c*0.4^2*(n*pi)^2*sin(0.4*pi*t)*sin(tilt)];
    ...
    elseif strcmpi(shape,'tricuspid') == 1
       rd = [c*cos(0.4*pi*t)+2*c*cos(0.2*pi*t)+ rd_0(1)-3*c;
        ...
        rd_dot = [-c*0.4*n*pi*sin(0.4*pi*t)-2*c*0.2*n*pi*sin(0.2*pi*t);
                   c*0.4*n*pi*cos(0.4*pi*t)*cos(tilt)-2*c*0.2*n*pi*cos(0.2*pi*t)*cos(tilt);
                   c*0.4*n*pi*cos(0.4*pi*t)*sin(tilt)-2*c*0.2*n*pi*cos(0.2*pi*t)*sin(tilt)];
                   
        rd_ddot = [-c*((0.4*n*pi)^2)*cos(0.4*pi*t)-2*c*((0.2*n*pi)^2)*cos(0.2*pi*t);
                   -c*((0.4*n*pi)^2)*sin(0.4*pi*t)*cos(tilt)+2*c*((0.2*n*pi)^2)*sin(0.2*pi*t)*cos(tilt);
                    -c*((0.4*n*pi)^2)*sin(0.4*pi*t)*sin(tilt)+2*c*((0.2*n*pi)^2)*sin(0.2*pi*t)*sin(tilt)];
    ...
    elseif strcmpi(shape,'star') == 1
       rd = [c*cos(0.6*pi*t)+2*c*cos(0.4*pi*t)+rd_0(1)-3*c;
        ...
        rd_dot = [-c*0.6*n*pi*sin(0.6*pi*t)-2*c*0.4*n*pi*sin(0.4*pi*t);
                 c*0.6*pi*n*cos(0.6*pi*t)*cos(tilt)-2*c*0.4*n*pi*cos(0.4*pi*t)*cos(tilt);
                 c*0.6*n*pi*cos(0.6*pi*t)*sin(tilt)-2*c*0.4*n*pi*cos(0.4*pi*t)*sin(tilt)];
                   
        rd_ddot =  [-c*((0.6*n*pi)^2)*cos(0.6*pi*t)-2*c*((0.4*n*pi)^2)*cos(0.4*pi*t);
                    -c*((0.6*n*pi)^2)*sin(0.6*pi*t)*cos(tilt)+2*c*((0.4*n*pi)^2)*sin(0.4*pi*t)*cos(tilt);
                    -c*((0.6*n*pi)^2)*sin(0.6*pi*t)*sin(tilt)+2*c*((0.4*n*pi)^2)*sin(0.4*pi*t)*sin(tilt)];
    ...
    elseif strcmpi(shape,'petal') == 1
       ...
       rd_dot = [-(0.2*n*pi)*c*sin(0.2*pi*t) - (0.6*n*pi)*c*sin(0.6*pi*t);
                 (0.2*n*pi)*c*cos(0.2*pi*t)*cos(tilt) - (0.6*n*pi)*c*cos(0.6*pi*t)*cos(tilt);
                 (0.2*n*pi)*c*cos(0.2*pi*t)*sin(tilt) - (0.6*n*pi)*c*cos(0.6*pi*t)*sin(tilt)];  
       
       rd_ddot = [-((0.2*n*pi)^2)*c*cos(0.2*pi*t) - ((0.6*n*pi)^2)*c*cos(0.6*pi*t);
                 -((0.2*n*pi)^2)*c*sin(0.2*pi*t)*cos(tilt) + ((0.6*n*pi)^2)*c*sin(0.6*pi*t)*cos(tilt);
                 -((0.2*n*pi)^2)*c*sin(0.2*pi*t)*sin(tilt) + ((0.6*n*pi)^2)*c*sin(0.6*pi*t)*sin(tilt)];
    end
